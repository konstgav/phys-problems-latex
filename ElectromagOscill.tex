...
\centering
\includegraphics[width = 0.9 \textwidth]{1219OscillatoryCircuitCCL.jpg}
\end{minipage}
\begin{ans}
...
\begin{minipage}{.35\textwidth}
\centering
\includegraphics[width = 0.9 \textwidth]{1220OscillatoryCircuitC1C2L.jpg}
\end{minipage}
\begin{ans}
...
\begin{minipage}{.35\textwidth}
\centering
\includegraphics[width = 0.9 \textwidth]{1223AlternatingCurrentCLR.jpg}
\end{minipage}
\begin{ans}
$\omega = 1/\sqrt{LC}$
\end{ans}
