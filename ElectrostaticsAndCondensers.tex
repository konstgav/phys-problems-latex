...
\end{minipage}
\begin{ans}
$I_{01} = \frac{3 \varepsilon}{3r+2R}$, $I_{02} = \frac{\varepsilon}{3r+2R}$
\end{ans}
\end{ex}
...
\hspace{0pt} \\
\begin{minipage}{.65\textwidth}
Батарея с ЭДС, равной {\Large $\varepsilon$}, конденсаторы емкостями $C_1$ и $C_2$ и резистор сопротивлением $R$ соединены так, как показано на рисунке. 
...
\end{minipage}
\begin{ans}
$Q=\frac{C_1C_2\varepsilon^2}{2(C_1+C_2)}$
\end{ans}
\end{ex}
...
\end{minipage}
\begin{ans}
1) $I_1=\frac{\varepsilon_1 + \varepsilon_2}{3R}$; 2) $Q=(C_1 \varepsilon_1^2 + C_2 \varepsilon_2^2/2)$
\end{ans}
\end{ex}
...
\begin{minipage}{.35\textwidth}
\centering
\includegraphics[width = 0.9 \textwidth]{1006Condensers.jpg}
\end{minipage}
\begin{ans}
1) $U_1 = \frac{2R\varepsilon}{r+3R}$, $U_2 = \frac{R\varepsilon}{r+3R}$; 2) $Q=\frac{3RC\varepsilon}{r+3R}$
\end{ans}
\end{ex}